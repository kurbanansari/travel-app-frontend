...
// import { messageReceived, setSelectedUser,Message } from "@/redux/slices/chatSlice";
...
//     // ✅ Only update Redux if the message belongs to this user
//     if (msg.sender.id === myUserId || msg.receiver.id === myUserId) {
...
//   };
// }, [socket, myUserId, dispatch]);


  
// // 1️⃣ Listen for incoming socket messages
//   // useEffect(() => {
//   //   if (!socket) return;
